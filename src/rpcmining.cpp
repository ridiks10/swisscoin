...
//    Litecoin and modified for SwissCoin.
//
//    Parameters: lookup (int) - How many blocks to look into the past.
//    Returns: Estimated SwissCoin network hash rate (uint64_t)
//
...
// WM - Implementation of getnetworkhashps for SwissCoin
Value getnetworkhashps(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            "getnetworkhashps\n"
            "Returns an estimate of the SwissCoin network hash rate.");
